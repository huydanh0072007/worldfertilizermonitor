...
export const PROCESSING_PLANTS: ProcessingPlant[] = [
  // Fertilizer Plants (Vietnam & Global)
  {
    id: 'plant-dam-phu-my',
    name: 'Nhà máy Đạm Phú Mỹ (PVFCCo)',
    lat: 10.536,
    lon: 107.031,
    type: 'processing',
    mineral: 'Copper', // fallback map mineral type
    country: 'Vietnam',
    operator: 'PVFCCo',
    status: 'operating',
    significance: 'Hệ thống nhà máy Urea & NPK hàng đầu Việt Nam. Công suất 800k tấn Urea + 540k tấn NPK/năm.',
  },
  {
    id: 'plant-dam-ca-mau',
    name: 'Nhà máy Đạm Cà Mau (PVCFC)',
    lat: 9.176,
    lon: 105.076,
    type: 'processing',
    mineral: 'Copper',
    ...
    operator: 'PVCFC',
    status: 'operating',
    significance: 'Nhà máy sản xuất hạt đục Urea Cà Mau công suất 800k tấn/năm phục vụ ĐBSCL & xuất khẩu.',
  },
  {
    id: 'plant-dam-ha-bac',
    ...
    operator: 'Vinachem',
    status: 'operating',
    significance: 'Nhà máy sản xuất Urea chạy bằng nguyên liệu than tại miền Bắc Việt Nam.',
  },
  {
    id: 'plant-dap-dinh-vu',
    name: 'Nhà máy DAP Đình Vũ',
    lat: 20.841,
    lon: 106.772,
    type: 'processing',
    mineral: 'Copper',
    country: 'Vietnam',
    operator: 'DAP - Vinachem',
    status: 'operating',
    significance: 'Nhà máy sản xuất phân DAP lớn nhất Việt Nam công suất 330k tấn/năm.',
  },
  {
    id: 'plant-dangote-nigeria',
    name: 'Dangote Fertilizer Complex',
    lat: 6.442,
    lon: 3.985,
    type: 'processing',
    mineral: 'Copper',
    ...
    status: 'operating',
    significance: 'Cụm nhà máy Urea lớn nhất Châu Phi, công suất 3.0 triệu tấn/năm.',
  },
  {
    id: 'plant-qafco-qatar',
    name: 'QAFCO Mesaieed Complex',
    lat: 24.987,
    lon: 51.551,
    type: 'processing',
    mineral: 'Copper',
    country: 'Qatar',
    operator: 'QAFCO / Industries Qatar',
    status: 'operating',
    significance: 'Cụm nhà máy sản xuất Urea & Ammonia đơn lẻ lớn nhất thế giới (5.6Mt Urea/năm).',
  },
  {
    id: 'plant-sabic-jubail',
    name: 'SABIC Agri-Nutrients Jubail',
    lat: 27.011,
    lon: 49.658,
    type: 'processing',
    mineral: 'Copper',
    ...
    operator: 'SABIC',
    status: 'operating',
    significance: 'Trung tâm sản xuất Phân đạm & NPK xuất khẩu hàng đầu Trung Đông.',
  },
